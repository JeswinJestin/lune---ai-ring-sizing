    ...
    useEffect(() => {
        ...
        const onResults = (results: any) => {
            ...
            if (results.multiHandLandmarks && results.multiHandLandmarks.length > 0) {
                ...
                // Define the target area for hand placement (center 50% horizontally, 60% vertically)
            ...
            // No instruction text rendered for AI scan method
            ...
            return (
                <>
                    ...
                    <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-0">
                        <div className={`w-2/5 aspect-square border-2 rounded-md transition-all duration-300 ${isHandDetected ? 'border-bronze-400 animate-glow-bronze' : 'border-white/50 border-dashed'}`}></div>
                    </div>
                </>
            );
        }
    ...
    const renderControls = () => {
        ...
        return (
            <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-black/80 to-transparent z-20">
                {/* Instruction text removed for AI scan; only controls remain */}
